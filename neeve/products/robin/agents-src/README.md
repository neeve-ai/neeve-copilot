...
Each agent is authored once as `agents-src/<name>/AGENT.md` and rendered by
...
`agents-src/neeve/AGENT.md` and `neeve/engineering-principles.md`.
...
`agents-src/<name>/AGENT.md` only when the workflow needs something a skill
