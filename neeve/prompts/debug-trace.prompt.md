---
description: Exhaustive, research-grounded trace when a shallow grep isn't rigorous enough
---
Use the `debug-trace` skill. Trace every method and sub-method in the actual
call chain to its persistence/cache/external boundary — not just far enough
to answer. If the trail touches a concept, package, library, or tool, research
