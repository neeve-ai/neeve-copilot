...
echo ""
echo "  Workflow:"
echo "    1. Edit a skill in neeve/skills/ (or neeve/products/<product>/skills/ for product-specific ones)"
echo "    2. Test locally:  bash sync_skills.sh"
echo "    3. Commit:        git add ... && git commit -m 'skills: ...'"
echo "       → post-commit hook auto-pushes to origin when skills changes"
echo ""
